...
namespace IdentityProviderSystem.Persistance.Migrations
{
    ...
    [Migration("20251006183502_refresh-token")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityProviderSystem.Domain.Models.Token.AccessToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IdentityProviderSystem.Domain.Models.Token.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IdentityProviderSystem.Domain.Models.Token.AccessToken", b =>
                {
                    b.HasOne("IdentityProviderSystem.Domain.Models.User.User", null)
                        .WithOne("AccessToken")
                        .HasForeignKey("IdentityProviderSystem.Domain.Models.Token.AccessToken", "UserId")
